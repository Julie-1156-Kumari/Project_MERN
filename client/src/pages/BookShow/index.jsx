...
const BookShow = () => {
  ...
  const getData = async () => {
    try {
      ...
      if (response.success) {
        ...
        console.log("get data from BookShow: ", response.data); // Logging show data to console
      } else {
  ...
  const onToken = async (token) => {
    console.log("token from bookshow", token);
    try {
      dispatch(showLoading());
            ...
            >
              ...
              {selectedSeats.length > 0 && (
                <StripeCheckout
                  ...
                  billingAddress
                  amount={selectedSeats.length * show.ticketPrice}
                  stripeKey="pk_test_51RusReLt1vjK9idTfJP17qjbNsM8IvJz21Vz9Kn2pVDWAd4sW57nXwBGoDe7lznMy4pHDsuaXMwcONxJiD7yXWfR00nYryVxwy"
                >
