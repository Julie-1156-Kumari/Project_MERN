...
import { Modal, Col, Row, Form, Input, Button, Select, message } from "antd";
              ...
              <Col span={8}>
                <Form.Item label="Select Movie Language" name="language">
                  <Input
                    ...
                    options={[
                      { vaule: "English", label: "English" },
                      { vaule: "Hindi", label: "Hindi" },
                      { vaule: "German", label: "German" },
                      { vaule: "Telugu", label: "Telugu" },
                    ]}
                  />
                </Form.Item>
              </Col>
